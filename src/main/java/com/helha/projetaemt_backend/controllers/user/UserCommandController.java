...
public class UserCommandController {
    ...
    public UserCommandController(CreateUserHandler createUserHandler, LoginUserHandler loginUserHandler) {
    ...
    public ResponseEntity<LoginUserOutput> login(@Valid @RequestBody LoginUserInput input) {
        LoginUserOutput output = loginUserHandler.handle(input);
